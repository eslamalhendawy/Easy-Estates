...
const EditAd = () => {
  ...
  useEffect(() => {
    document.title = `Easy Estates | Edit Ad`;
    window.scrollTo(0, 0);
    fetchAds();
  }, []);
  ...
  return (
    <main dir={i18n.language === "ar" ? "rtl" : "ltr"} className="container mx-auto px-2 sm:px-8 xl:px-24 py-8 minHeight font-gothic">
      <h1 className="font-goldman font-bold text-xl md:text-[32px] xl:text-[45px] mb-8">{t("editAd")}</h1>
      <div className="border border-lightGrey my-8 rounded-xl mx-auto lg:mx-12 xl:mx-24">
        ...
        <div className="px-6 pb-3 flex flex-col gap-2 md:flex-row md:gap-0">
          ...
          <div className="grow">
            <input value={squareFootage} placeholder={t("enterAreaM2")} onChange={(e) => setSquareFootage(e.target.value)} type="text" className="border border-[#D9D9D9] outline-none px-2 py-2 rounded-lg w-full focus:border-darkGrey duration-200" />
          </div>
        </div>
        {/* Furniture */}
        <div className="px-6 pb-3 flex flex-col gap-2 md:flex-row md:gap-0">
        ...
        <div className="px-6 pb-3 flex flex-col gap-2 md:flex-row md:gap-0">
          ...
          <div className="grow">
            <Select value={bedrooms} onValueChange={(e) => setBedrooms(e)}>
        ...
        <div className="px-6 pb-6 flex flex-col gap-2 md:flex-row md:gap-0 border-b border-lightGrey">
          ...
          <div className="grow">
            <Select value={bathrooms} onValueChange={(e) => setBathrooms(e)}>
              <SelectTrigger dir={i18n.language === "ar" ? "rtl" : "ltr"} className="basis-1/3 outline-none">
        ...
        <div className="px-6 pb-3 flex flex-col gap-2 md:flex-row md:gap-0">
          ...
          <div className="grow">
            <input value={address} placeholder={t("enterAddress")} onChange={(e) => setAddress(e.target.value)} type="text" className="border border-[#D9D9D9] outline-none px-2 py-2 rounded-lg w-full focus:border-darkGrey duration-200" />
          </div>
        </div>
        {/* Phone Number */}
        <div className="px-6 pb-3 flex flex-col gap-2 md:flex-row md:gap-0">
        ...
        <div className="px-6 pb-6 flex flex-col gap-2 md:flex-row md:gap-0 border-b border-lightGrey">
          ...
          <div className={`md:grow flex flex-col sm:flex-row gap-2 mb-2 ${i18n.language === "ar" && "flex-row-reverse"}`}>
            ...
            <input value={price} onChange={(e) => setPrice(e.target.value)} placeholder={t("enterPrice")} type="text" id="price" className="border border-[#D9D9D9] outline-none px-2 py-2 rounded-lg w-full focus:border-darkGrey duration-200" />
          </div>
        </div>
        {/* Description */}
        <div className="px-6 pb-3 pt-6 flex flex-col gap-2 md:flex-row md:gap-0">
          ...
          <div className="grow">
            <textarea value={description} placeholder={t("describeTheProperty")} onChange={(e) => setDescription(e.target.value)} className="border resize-none h-[180px] border-[#D9D9D9] outline-none px-2 py-2 rounded-lg w-full focus:border-darkGrey duration-200"></textarea>
          </div>
        </div>
        {/* Title */}
        <div className="px-6 pb-3 flex flex-col gap-2 md:flex-row md:gap-0">
          ...
          <div className="grow">
            <input value={title} placeholder={t("enterTitle")} onChange={(e) => setTitle(e.target.value)} type="text" className="border border-[#D9D9D9] outline-none px-2 py-2 rounded-lg w-full focus:border-darkGrey duration-200" />
          </div>
        </div>
        {/* Button */}

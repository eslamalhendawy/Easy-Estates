  ...
  return (
    <div dir={i18n.language === "ar" ? "rtl" : "ltr"} className="bg-redColor lg:flex items-stretch xl:items-center relative">
      ...
      <div className="px-8 xl:px-12 py-8 text-white basis-2/3">
        ...
        <h1 className="font-goldman text-2xl sm:text-3xl lg:text-4xl xl:text-5xl 2xl:text-[50px] 2xl:w-[70%] font-semibold capitalize mb-4 xl:mb-6 2xl:mb-8">{t("isc")}</h1>
        <p className={`font-gothic font-semibold  border-white sm:text-md lg:text-lg xl:text-xl xl:w-[80%] 2xl:w-[70%] ${i18n.language === "ar" ? "lg:pr-2 lg:border-r-[3px]" : "lg:pl-2 lg:border-l-[3px]"}`}>{t("heroDescription")}</p>
      </div>
